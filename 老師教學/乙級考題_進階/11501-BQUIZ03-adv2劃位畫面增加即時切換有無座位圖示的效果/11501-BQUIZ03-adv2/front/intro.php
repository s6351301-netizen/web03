    ...
    <div class="tab rb" style="width:87%;">
      <div style="background:#FFF; width:100%; color:#333; text-align:left">
        ...
        <p style="margin:3px">影片名稱 ：<?= $row['name'] ?>
          <input type="button" value="線上訂票" onclick="location.href='?do=booking&id=<?= $row['id']; ?>'" style="margin-left:50px; padding:2px 4px" class="b2_btu">
        </p>
        <p style="margin:3px">影片分級 ： <img src="icon/03C0<?= $row['level'] ?>.png" style="display:inline-block;"><?= $levelStr[$row['level']]; ?> </p>
